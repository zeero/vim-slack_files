...
function! s:suite.open()
  ...
  try
    ...
    call slack_files#open(url, id, filetype, title)
...
function! s:suite.open_is_configurable_for_opener()
  ...
  try
    ...
    call slack_files#open(url, id, filetype, title, {'opener': opener})
...
function! s:suite.write()
  ...
  try
    ...
    call slack_files#write(filename, contents)
...
function! s:suite.get_token_returns_first_line_of_token_file()
  ...
  let actual = slack_files#get_token()
